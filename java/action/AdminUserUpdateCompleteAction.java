...
public class AdminUserUpdateCompleteAction extends ActionSupport implements SessionAware{
	...
	public String execute(){
		...
		session.put("id", id);
		int count = userInfoDAO.userUpdate(Integer.parseInt(session.get("id").toString()),familyName, firstName, familyNameKana, firstNameKana, sex, email, loginId, password);
		...
		if(count > 0){
			...
			System.out.println("ユーザーの更新を行いました");
